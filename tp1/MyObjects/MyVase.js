    ...
    initVase(){
        ...
        let controlPoints = [   
            ...
            [ 
                // V = 0..6
                [ 0.8, 0, 0, 1 ], //start
                [ 0.8, 0, 0.8*(2/3)+0.8/2, 1], //cp1
                [ -0.8, 0, 0.8*(2/3)+0.8/2, 1], //cp2
                [ -0.8, 0, 0, 1 ], //middle
                //[ -1.6, 0, -1.6*(2/3), 1], //cp3
                //[ 1.6, 0, -1.6*(2/3), 1], // cp4
                //[ 1.6, 0, 0, 1 ], // final
            ...
            [ 
                // V = 0..6
                [ 1.525, 0.85, 0, 1 ],
                [ 1.525, 0.85, 1.525*(2/3)+1.525/2, 1],
                [ -1.525, 0.85, 1.525*(2/3)+1.525/2, 1],
                [ -1.525, 0.85, 0, 1 ],
                //[ -3.05, 1.7, -3.05*(2/3), 1],
                //[ 3.05, 1.7, -3.05*(2/3), 1],
            ...
            [ 
                // V = 0..6
                [ 0.865, 1.95, 0, 1 ],
                [ 0.865, 1.95, 0.865*(2/3)+0.865/2, 1],
                [ -0.865, 1.95, 0.865*(2/3)+0.865/2, 1],
                [ -0.865, 1.95, 0, 1 ],
                //[ -1.73, 3.9, -1.73*(2/3), 1],
                //[ 1.73, 3.9, -1.73*(2/3), 1],
            ...
            [ 
                // V = 0..6
                [ 1.05, 2.25, 0, 1 ],
                [ 1.05, 2.25, 1.05*(2/3)+1.05/2, 1],
                [ -1.05, 2.25, 1.05*(2/3)+1.05/2/2, 1],
                [ -1.05, 2.25, 0, 1 ],
                //[ -2.1, 4.5, -2.1*(2/3), 1],
                //[ 2.1, 4.5, -2.1*(2/3), 1],
                //[ 2.1, 4.5, 0, 1 ],
