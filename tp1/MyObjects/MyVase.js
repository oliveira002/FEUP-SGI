    ...
    initVase(){
        ...
        let controlPoints = [   
            ...
            [ 
                // V = 0..6
                [ 0.8/2, 0, 0, 1 ], //start
                [ 0.8/2, 0, 0.8*(4/3)/2, 1], //cp1
                [ -0.8/2, 0, 0.8*(4/3)/2, 1], //cp2
                [ -0.8/2, 0, 0, 1 ], //middle
                //[ -1.6, 0, -1.6*(2/3), 1], //cp3
                //[ 1.6, 0, -1.6*(2/3), 1], // cp4
                //[ 1.6, 0, 0, 1 ], // final
