...
class MySnow extends THREE.Object3D {
    ...
    constructor(app, scene) {
        ...
        for ( var i = 0; i < length; i ++ ) {
            var x = this.getRandom(-500, 500);
            var y = this.getRandom(300, 400);
            var z = this.getRandom(-500, 500);
            vertices.push( x, y, z );
        }
        ...
        var parameters = [
            ["#FFFFFF", sprite2, this.getRandom(10, 10) ],
            ["#FFFFFF", sprite3, this.getRandom(10, 15) ],
            ["#FFFFFF", sprite1, this.getRandom(10, 15) ],
            ["#FFFFFF", sprite5, this.getRandom(5, 10) ],
            ["#FFFFFF", sprite4, this.getRandom(5, 10) ]
        ];
